...
public class InspectorInterface : MonoBehaviour {
    ...
    {
        if(Input.mousePosition.x == Screen.width - Data._inspectorWidth)
        {
            Data._inspectorWidth++;
        }
    }
